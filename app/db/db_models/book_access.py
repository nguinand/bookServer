...
class BookAccess(Base):
    ...
    embeddable: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    public_domain: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    epub_available: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    epub_token_link: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    pdf_available: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
