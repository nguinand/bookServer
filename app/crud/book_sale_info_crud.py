...
def create_book_sale_info(
    book_sale_info_model: BookSaleInfoModel, session: Session
) -> BookSaleInfo:
...
def update_book_sale_info(
    book_sale_info_replacement: BookSaleInfoModel, session: Session
) -> None | BookSaleInfo:
...
def delete_book_sale_info(book_sale_info_id: int, session: Session) -> bool:
...
def convert_book_sale_info(book_sale_info_data: BookSaleInfo) -> BookSaleInfoModel:
    converted_book_sale_info = BookSaleInfoModel(
        ...
        retailPrice=PriceModel(
            ...
            currencyCode=CurrencyCode(book_sale_info_data.retail_price_currency_code)
