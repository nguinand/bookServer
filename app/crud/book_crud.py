...
class BookCrud:
    def create_book(self, book_model: BookModel, session: Session) -> Book:
        ...
        if book_model.access_info:
            ...
            book_data.access_info = BookAccess(
                ...
                epub_available=(
                    access_info_model.epub.isAvailable
                    if access_info_model.epub
                    else None
                ),
                epub_token_link=(
                    access_info_model.epub.acsTokenLink
                    if access_info_model.epub
                    else None
                ),
                pdf_available=(
                ...
                pdf_token_link=(
                    access_info_model.pdf.acsTokenLink
    ...
    def update_book(self, book_replacement: BookModel, session: Session) -> None | Book:
        ...
        book_record = self.get_book_by_id(book_replacement.id, session)
    ...
    def convert_book_to_model(self, book: Book) -> BookModel:
